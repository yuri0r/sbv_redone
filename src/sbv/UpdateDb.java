...
public class UpdateDb {
    ...
    public static void updateClassTable() throws Exception {
    ...
    public static void updateClassStudentTable() throws Exception {
    ...
    public static void classes(String Klasse,String ID) throws Exception {
